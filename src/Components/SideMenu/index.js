  ...
  return (
    <div className="SideMenu">
      ...
      >
        ...
        <Menu.Item key="/Media/AddAlbumName">Add Songs AlbumNames</Menu.Item>
        <Menu.Item key="/Media/AlbumComponent">Get All Songs AlbumNames</Menu.Item>
          ...
          <Menu.Item key="/Media/Addsubfolderaudio">subfolderaudiomessage</Menu.Item>
